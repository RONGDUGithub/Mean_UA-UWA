...
selected_data = np.random.choice(data, size=100, replace=False)
result_duchi=duchi(data,min_data,max_data,0.5)#第一个变量：数据集    第二个变量：数据下界（这里是0） 第三个变量：数据上界（这里是1000） 第四个变量：隐私预算
#piecewise:
selected_data = np.random.choice(data, size=1000, replace=False)
result_piecewise=duchi(data,min_data,max_data,0.5)#第一个变量：数据集    第二个变量：数据下界（这里是0） 第三个变量：数据上界（这里是1000） 第四个变量：隐私预算
#hybrid:
selected_data = np.random.choice(data, size=5000, replace=False)
result_hybrid=duchi(data,min_data,max_data,0.5)#第一个变量：数据集    第二个变量：数据下界（这里是0） 第三个变量：数据上界（这里是1000） 第四个变量：隐私预算
#laplace:
selected_data = np.random.choice(data, size=10000, replace=False)
result_laplace=duchi(data,min_data,max_data,0.5)#第一个变量：数据集    第二个变量：数据下界（这里是0） 第三个变量：数据上界（这里是1000） 第四个变量：隐私预算
#sw_unbiased:
selected_data = np.random.choice(data, size=100000, replace=False)
result_sw_unbiased=duchi(data,min_data,max_data,0.5)#第一个变量：数据集    第二个变量：数据下界（这里是0） 第三个变量：数据上界（这里是1000） 第四个变量：隐私预算
